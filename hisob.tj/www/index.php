...
<div style="width:1333px;height:200px; background-image: url(../img/header.jpg);background-size:1333px 200px;background-repeat: no-repeat;"></div>	
...
<input style="width:750px;min-width:750px;padding:10px; margin-top:20px; margin-left:30px;font-size:14pt;color:#666;" type="text" name="a" 
